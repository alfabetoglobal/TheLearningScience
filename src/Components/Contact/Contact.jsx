    ...
    return (
        ...
        <div className="contact-us">
            <div className="contact-us-header">
                ...
                <ReactPlayer className="video" playing={true} controls={true} url='https://video.wixstatic.com/video/11062b_b1015cefa07e4c0b82f6601db2d1028f/720p/mp4/file.mp4' height="30rem" width="100%" />
